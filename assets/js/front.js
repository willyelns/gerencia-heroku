...
function atualizaTempo(){
	$(".horarioAtual").html(new Date().toLocaleTimeString('pt-BR', { hour12: false, hour: "numeric", minute: "numeric", second: "numeric"}));
	setTimeout("atualizaTempo()",1000);				
}

(function blink() { 
  $('.thinker-second').fadeOut(1000).fadeIn(1000, blink); 
})();
